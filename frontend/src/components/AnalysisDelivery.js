...
const AnalysisDelivery = () => {
    ...
    const groupDataByCity = (data) => {
        return data.reduce((acc, curr) => {
            const city = curr.city; // Assuming 'city' field is present in the data
    ...
    return (
        <div>
            <div className='bg-white py-2 mt-1 px-4 rounded-lg flex justify-between items-center customShadow1'>
                <h2 className='font-bold text-lg'>Analysis of Citywise Orders</h2>
            </div>
                    ...
                    {selectCategory && (
                        <div>
                            <div className=' py-2 mt-1 px-4 flex justify-center items-center'>
                                <h1 className='font-bold text-lg capitalize'>City vs Order</h1>
                            </div>
...
export default AnalysisDelivery
